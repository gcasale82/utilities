...
dns_list = ['208.67.222.222' , '208.67.220.220' , '1.1.1.1' , '8.8.8.8' , '9.9.9.9' , '8.8.4.3']
url_list = ['google.it' , 'cisco.com' , 'apple.com' , 'microsoft.com55']
test_list = {}
test_connection = {}
...
def test_alldns():
    for dns in dns_list :
        ...
        if connection : test_connection[dns] = True
...
def report():
    ...
    for k,v in test_list.items() :
        if all(v) : print(f"{bcolors.OKGREEN} DNS {k} has resolved successfully all {bcolors.ENDC}")
